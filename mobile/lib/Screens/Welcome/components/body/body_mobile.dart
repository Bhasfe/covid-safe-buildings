...
import 'package:covid_safe_building/Screens/Welcome/components/background.dart';
import 'package:covid_safe_building/components/rounded_button.dart';
import 'package:covid_safe_building/constants.dart';
    ...
    return Background(
      child: SingleChildScrollView(
        child: Column(
          ...
          children: <Widget>[
            const Text(
              "Welcome to COVID-19 Safe Building",
